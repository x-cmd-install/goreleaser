...
[![x-cmd/install — goreleaser Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/goreleaser.svg?lang=zh)](https://x-cmd.com/install/goreleaser)
...
合计: **109,007** 行代码（覆盖前 5 种语言、共 **475** 个文件）。
...
- **最新版本**: `v2.19.0-ff8de3d6-nightly` (2026-09-17)
- **最近提交**: 2026-09-20
- **Release 含资产**: 55 个

## 流行度

- **Star**: 16,066 · **Fork**: 1,111 · **开放 issue**: 1,846 · **贡献者**: 487

## 累计统计

- **发布数**: 602 · **已合并 PR**: 4019 · **开放 PR**: 9 · **已关闭 issue**: 1837 · **开放 issue**: 9 · **提交数**: 8162

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 7 | 120 | 7 | 203 | 2 | 126 |
| last60d | 2026-07-26 | 9 | 186 | 7 | 211 | 3 | 206 |
| 90d | 2026-06-26 | 10 | 228 | 8 | 218 | 3 | 264 |
| last180d | 2026-03-28 | 17 | 338 | 8 | 240 | 3 | 527 |
| 360d | 2025-09-29 | 29 | 561 | 8 | 276 | 3 | 1042 |
| last720d | 2024-10-04 | 57 | 1202 | 9 | 375 | 5 | 2221 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/goreleaser.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:04:02Z._
